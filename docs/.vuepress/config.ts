...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  // theme: "vdoing", // 使用npm主题包（发布站点时用）
  theme: resolve(__dirname, "../../vdoing"), // 使用本地主题包（本地开发/构建时用，使 vdoing 下修改生效）
    ...
    nav: [
      { text: "首页", link: "/" },
      {
        ...
        items: [
          ...
          { text: "SpringBoot配置文件加密处理", link: "/doc/d0007/"},
          { text: "SpringBoot优雅的抛出业务异常", link: "/doc/d0008/"},
          { text: "通用大模型适配器", link: "/doc/d0009/"},
          { text: "10分钟快速搭建个人博客", link: "/doc/d0010/"},
        ],
      },
      {
        text: "笔记",
